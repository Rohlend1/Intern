...
public class CarService {
    ...
    public List<Space> getFreeSpace(){
        return serviceOperation.getFreeSpace();
    }

    public void setOrderToExecuting(int orderId){
        serviceOperation.setOrderToExecuting(orderId);
    }

    public List<Order> getExecutingOrders(){
        return serviceOperation.getExecutingOrders();
    }

    public List<Order> getSortedOrders(){
        return serviceOperation.getSortedOrders();
    }

    public List<Mechanic> getSortedMechanics(){
        return serviceOperation.getSortedMechanics();
    }

    public List<Order> getOrdersByMechanicId(int mechanicId){
        return serviceOperation.getOrdersByMechanicId(mechanicId);
    }

    public void setSpaceIsBusy(int spaceId){
        serviceOperation.setSpaceIsBusy(spaceId);
    }
    ...
    public void testGetFreeSpace(){
        prepareTestEnvironment();
        System.out.println("Test get free space");
        System.out.println("-------------BEFORE:------------");
        System.out.println(this.getFreeSpace());
        System.out.println("-------------AFTER:------------");
        this.setSpaceIsBusy(this.getGarage().get(0).getId());
        System.out.println(this.getFreeSpace());
        System.out.println("---------------------------------");
    }

    public void testGetExecutingOrders(){
        prepareTestEnvironment();
        System.out.println("Test get executing orders");
        System.out.println("-------------BEFORE:------------");
        System.out.println(this.getExecutingOrders());
        System.out.println("-------------AFTER:------------");
        this.setOrderToExecuting(this.getOpenOrders().get(0).getId());
        this.setOrderToExecuting(this.getOpenOrders().get(1).getId());
        System.out.println(this.getExecutingOrders());
        System.out.println("---------------------------------");
    }
    ...
    public void testGetSortedOrders(){
        prepareTestEnvironment();
        System.out.println("Test get sorted orders");
        System.out.println("-------------BEFORE:------------");
        System.out.println(this.getOpenOrders());
        System.out.println("-------------AFTER:------------");
        System.out.println(this.getSortedOrders());
        System.out.println("---------------------------------");
    }

    public void testGetSortedMechanics(){
        prepareTestEnvironment();
        System.out.println("Test get sorted mechanics");
        System.out.println("-------------BEFORE:------------");
        System.out.println(this.getMechanics());
        System.out.println("-------------AFTER:------------");
        System.out.println(this.getSortedMechanics());
        System.out.println("---------------------------------");
    }

    public void testGetOrdersByMechanicId(){
        prepareTestEnvironment();
        System.out.println("Test get orders by mechanic");
        System.out.println("---------------------------------");
        System.out.println(this.getOrdersByMechanicId(this.getMechanics().get(1).getId()));
        System.out.println("---------------------------------");
    }
